...
# Read in the data
fish1a <- read.csv( "LargeFishSimulatedData1.csv", 
...
write.table( FishOut1, "MediumLargeFishAnalysisOut1.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep =",",
             col.names =FALSE)
write.table( FishOut0, "MediumLargeFishAnalysisOut2.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE)
write.table( FishOut3, "MediumLargeFishAnalysisOut3.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE )
