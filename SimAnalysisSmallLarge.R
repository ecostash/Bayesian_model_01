...
write.table( FishOut1, "SmallLargeFishAnalysisOut1.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep =",",
             col.names =FALSE)
write.table( FishOut0, "SmallLargeFishAnalysisOut2.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE)
write.table( FishOut3, "SmallLargeFishAnalysisOut3.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE )
