...
write.table( FishOut1, "LargeMediumFishAnalysisOut1.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep =",",
             col.names =FALSE)
write.table( FishOut0, "LargeMediumFishAnalysisOut2.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE)
write.table( FishOut3, "LargeMediumFishAnalysisOut3.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE )
