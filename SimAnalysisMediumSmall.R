...
# Read in the data
fish1a <- read.csv( "SmallFishSimulatedData1.csv", 
...
write.table( FishOut1, "MediumSmallFishAnalysisOut1.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep =",",
             col.names =FALSE)
write.table( FishOut0, "MediumSmallFishAnalysisOut2.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE)
write.table( FishOut3, "MediumSmallFishAnalysisOut3.csv", 
             row.names = FALSE, 
             append = TRUE,
             sep = ",",
             col.names = FALSE )
...
LocFishOut3 <- FishOut0$Region2
ProfFishOut3 <- FishOut0[,6:17]
